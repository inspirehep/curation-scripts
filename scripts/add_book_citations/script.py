...
BOOKS = [
 {'recid': '2735748',
  'book_info': ['Rezzolla', 'Zanotti', 'Relativistic Hydrodynamics',
                'Oxford University Press', '2013']},
 {'recid': '181166',
  'book_info': ['Birrell', 'Davies', 'Quantum Fields in Curved Space',
                'Cambridge University Press', '1982']},
 {'recid': '159194',
  'book_info': ['Itzykson', 'Zuber', 'Quantum Field Theory',
                'McGraw', '1980']},
 {'recid': '640063',
  'book_info': ['Dodelson', 'Modern Cosmology',
                'Academic Press', '2003']},
 {'recid': '1120339',
  'book_info': ['Baxter', 'Exactly solved models in statistical mechanics',
                'Academic Press', '1982']},
]
    ...
    def do(record, logger, state):
        ...
        for reference in record['references']:
            try:
                ...
                continue
            if all(book_element.lower() in raw_ref for
                   book_element in book_info):
